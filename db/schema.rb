...
ActiveRecord::Schema.define(version: 20160809071748) do
  ...
  add_index "photos", ["mannequin_id"], name: "index_photos_on_mannequin_id", using: :btree
  ...
  add_foreign_key "photos", "mannequins"
end
